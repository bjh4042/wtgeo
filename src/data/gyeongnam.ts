...
const defaultGyeongnamCities: GyeongnamCity[] = [
  ...
  {
    id: 'changwon', name: '창원특례시', nameHanja: '昌原特例市',
    population: 1005300, area: 748.06,
    mascot: '피우미', mascotEmoji: '🌸',
    officialSite: 'https://www.changwon.go.kr',
    nameOrigin: '창원특례시는 \'번성하는 벌판\'이라는 뜻을 가진 이름처럼 경상남도청이 위치한 행정의 중심지예요. 마산, 창원, 진해 세 도시가 하나로 합쳐져 아주 큰 도시가 되었고, 기계 산업이 발달한 계획도시로 유명하며 매년 봄이면 진해 구역에서 아름다운 벚꽃이 가득 피는 군항제가 열려 많은 사람이 찾아온답니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'보배로운 마을\'이라는 의미를 담은 진주시는 서부 경남의 교육과 문화가 시작된 중심지예요. 임진왜란 당시 큰 승리를 거둔 진주대첩의 현장인 진주성이 잘 보존되어 있으며, 매년 가을이면 밤바다와 남강을 아름답게 수놓는 유등축제가 열려 환상적인 풍경을 자랑합니다.',
  ...
  },
  {
    ...
    nameOrigin: '조선 시대 해군 본부였던 \'통제영\'이 설치되었던 곳이라 통영이라는 이름이 붙었는데, 바다와 섬이 무척 아름다워 \'동양의 나폴리\'라고도 불려요. 이순신 장군의 한산대첩이 일어난 역사적인 장소이며, 맛있는 굴과 충무김밥, 그리고 예쁜 그림이 가득한 동피랑 벽화마을이 아주 유명합니다.',
  ...
  },
  {
    ...
    nameOrigin: '물이 깊고 맑은 곳이라는 뜻을 가진 사천시는 삼천포와 사천이 하나로 합쳐진 도시로, 우리 나라의 비행기를 만드는 항공 우주 산업이 아주 발달한 곳이에요. 바다 위를 시원하게 가로지르는 사천 바다케이블카와 비행기의 역사를 배우는 항공우주박물관이 있어 볼거리가 풍부합니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'철이 많이 나는 바닷가 고을\'이라는 뜻의 김해시는 아주 먼 옛날 가야 시대 중 금관가야의 수도였던 곳이에요. 그래서 수로왕릉 같은 가야의 유적지가 도시 곳곳에 아주 많으며, 국립김해박물관과 노무현 전 대통령의 생가가 있는 봉하마을이 이곳에 위치하고 있습니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'햇볕이 잘 드는 곳\'이라는 따뜻한 이름을 가진 밀양시는 영남루라는 아름다운 누각과 기름진 땅을 가진 평화로운 고장이에요. 우리나라 3대 민요 중 하나인 \'밀양아리랑\'의 고향이기도 하며, 한여름에도 차가운 얼음이 어는 신비한 얼음골이 있어 관광객들이 많이 찾는답니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'크게 구제한다\'는 뜻의 거제시는 우리나라에서 두 번째로 큰 섬으로, 6.25 전쟁 때 많은 피란민을 따뜻하게 받아준 역사를 간직하고 있어요. 세계적인 조선소가 두 곳이나 있어 커다란 배를 아주 잘 만들며, 거가대교로 부산과 연결되어 있고 바람의 언덕처럼 풍경이 예쁜 곳이 정말 많습니다.',
  ...
  },
  {
    ...
    nameOrigin: '산의 모양이 집의 들보와 비슷하다고 해서 이름 붙여진 양산시는 부산, 울산과 가까워 신도시가 생기며 아주 빠르게 성장하고 있는 도시예요. 유네스코 세계문화유산으로 지정된 유서 깊은 절인 통도사가 있어 전 세계에서 많은 사람이 방문하는 곳이기도 합니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'옳은 일을 하는 고장\'이라는 뜻의 의령군은 임진왜란 때 곽재우 장군이 처음으로 의병을 일으켜 나라를 지킨 용감한 선비의 고장이에요. 경상남도의 한가운데 자리 잡고 있으며, 전통적인 소싸움 대회가 열려 박진감 넘치는 구경거리를 제공합니다.',
  ...
  },
  {
    ...
    nameOrigin: '아라가야라는 나라의 중심지였던 함안군은 \'모두가 편안하다\'는 평화로운 이름을 가진 곳이에요. 말이산 고분군처럼 옛 가야의 흔적이 많이 남아 있어 역사를 공부하기 좋으며, 아주 달고 맛있는 수박이 많이 생산되는 곳으로도 유명합니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'번성하고 편안하다\'는 뜻을 가진 창녕군은 옛날에는 비사벌이라고 불렸던 역사가 깊은 곳이에요. 우리나라에서 가장 크고 오래된 자연 늪인 우포늪이 있어 아주 귀한 새들과 식물들이 살고 있으며, 태고의 신비로운 자연을 직접 관찰할 수 있는 소중한 곳입니다.',
  ...
  },
  {
    ...
    nameOrigin: '소가야의 수도였으며 높은 성이 있다는 뜻의 고성군은 전 세계에서 공룡 발자국 화석이 아주 많이 발견되는 \'공룡의 고장\'으로 유명해요. 어린이들이 좋아하는 공룡 박물관과 공룡 세계 엑스포가 열려 공룡 시대로 여행을 떠난 것 같은 기분을 느낄 수 있습니다.',
  ...
  },
  {
    ...
    nameOrigin: '남쪽 바다에 있는 큰 섬이라는 뜻의 남해군은 다리로 육지와 연결되어 있으며, 경치가 너무 아름다워 \'보물섬\'이라는 별명을 가지고 있어요. 산비탈에 계단 모양으로 만든 논이 펼쳐진 다랭이마을이 아주 유명하며 평화로운 바다 풍경이 일품입니다.',
  ...
  },
  {
    ...
    nameOrigin: '섬진강 아래쪽에 위치했다는 뜻의 하동군은 경상도와 전라도를 잇는 정겨운 길목 역할을 해요. 지리산 자락에서 자란 맑은 녹차와 섬진강에서 잡은 재첩이 아주 유명하며, 노래 가사로도 잘 알려진 화개장터에서 옛 시장의 활기를 느낄 수 있습니다.',
  ...
  },
  {
    ...
    nameOrigin: '산이 높고 물이 맑다는 뜻을 가진 산청군은 지리산의 정기를 받아 몸에 좋은 약초가 아주 많이 나는 건강한 고장이에요. 그래서 한방 의료와 관련된 축제가 열리고 동의보감촌 같은 시설이 잘 갖춰져 있어 건강을 챙기러 오는 사람들이 많습니다.',
  ...
  },
  {
    ...
    nameOrigin: '모든 곳에 따뜻한 햇볕이 잘 든다는 뜻의 함양군은 옛날 선비들이 공부하던 서원과 정자가 많아 전통문화가 잘 보존된 곳이에요. 신라 시대 최치원 선생이 홍수를 막기 위해 직접 나무를 심어 만든 상림숲은 사계절 내내 아름다운 산책길을 선물해 줍니다.',
  ...
  },
  {
    ...
    nameOrigin: '\'크고 넓은 밝은 벌판\'이라는 시원한 이름을 가진 거창군은 공부하기 좋은 교육의 도시로도 아주 잘 알려져 있어요. 여름에 물놀이하기 좋은 수승대 계곡이 있으며, 아삭아삭하고 당도가 높은 거창 사과가 전국적으로 유명한 특산물입니다.',
  ...
  },
  {
    ...
    nameOrigin: '여러 갈래의 물줄기가 하나로 합쳐진다는 뜻의 합천군은 팔만대장경을 모시고 있는 유서 깊은 해인사가 있는 곳이에요. 봄에는 붉은 철쭉이, 가을에는 은빛 억새가 온 산을 뒤덮는 아름다운 황매산이 있어 사계절 내내 등산객들에게 사랑받는 고장입니다.',
...
// 시군별 상세 정보 (자연환경/특산물·산업/문화유산·축제)
const CITY_DETAILS: Record<string, GyeongnamCity['details']> = {
  changwon: {
    nature: '남쪽으로는 파도가 잔잔한 마산만과 진해만이 있고, 도시 주변을 불모산과 무학산 같은 높은 산들이 병풍처럼 둘러싸고 있어 아늑한 지형입니다.',
    industry: '전국에서 가장 많이 생산되는 달콤하고 아삭한 단감이 유명합니다. 로봇, 기계, 자동차 부품을 만드는 아주 큰 공장들이 모여 있는 공업 도시입니다.',
    culture: '매년 3월 말에서 4월 초, 벚꽃이 가득 핀 거리를 걸으며 해군 문화를 체험하는 \'진해군항제\'가 열립니다. 가을인 10월~11월에는 화려한 국화를 볼 수 있는 \'마산국화축제\'도 열립니다.',
  },
  jinju: {
    nature: '도시 한가운데로 맑고 푸른 남강이 흐르고 있으며, 강 주변으로 농사짓기 좋은 평평한 땅이 펼쳐져 있습니다.',
    industry: '부드럽고 색깔이 고운 천인 \'실크(비단)\'를 만드는 산업이 예전부터 아주 크게 발달했습니다. 신선한 딸기와 고추도 많이 재배합니다.',
    culture: '임진왜란 때 진주성에서 싸운 역사를 기억하기 위해, 매년 10월 가을밤 강물 위에 수많은 예쁜 등을 띄우는 \'진주 남강유등축제\'가 열립니다.',
  },
  tongyeong: {
    nature: '육지와 바다가 만나는 해안선이 복잡하게 구불구불하며, 맑은 바다 위에 크고 작은 아름다운 섬들이 500개 넘게 떠 있습니다.',
    industry: '깨끗한 바다에서 밧줄을 매달아 키우는 굴과 멍게가 전국에서 제일 유명합니다. 조개껍데기로 예쁘게 장식하는 \'나전칠기\' 공예도 발달했습니다.',
    culture: '이순신 장군이 바다에서 크게 승리한 한산도 대첩을 기념하기 위해, 매년 8월 여름에 배들이 바다로 나가는 \'통영한산대첩축제\'가 열립니다.',
  },
  sacheon: {
    nature: '맑은 바다와 부드러운 갯벌이 넓게 펼쳐져 있고, 뒤쪽으로는 와룡산이라는 웅장한 산이 도시를 지켜주는 모양입니다.',
    industry: '우리나라의 우주선과 비행기를 연구하고 만드는 \'항공우주 산업\'의 중심지입니다. 바다에서는 쥐치, 멸치 같은 맛있는 생선이 많이 잡힙니다.',
    culture: '매년 10월 가을, 하늘 위에서 멋진 비행기 묘기를 직접 볼 수 있고 비행기도 타볼 수 있는 \'사천에어쇼\'가 열립니다.',
  },
  gimhae: {
    nature: '낙동강이 바다와 만나기 전에 만들어 놓은 \'김해평야\'라는 아주 넓고 기름진 들판이 있어 옛날부터 사람들이 살기 좋았습니다.',
    industry: '넓은 들판에서 자라는 질 좋은 쌀과 진영 지역의 단감이 유명합니다. 옛날부터 흙으로 도자기를 굽는 기술이 뛰어나고, 지금은 다양한 물건을 만드는 공장도 많습니다.',
    culture: '수로왕릉 등 옛날 \'가야\' 시대의 역사와 문화를 배우고 체험하기 위해, 매년 4월에서 5월 사이에 \'가야문화축제\'가 열립니다.',
  },
  miryang: {
    nature: '영남알프스라고 불리는 아주 높고 험한 산들이 병풍처럼 둘러싸고 있으며, 산에서 내려온 맑은 물이 밀양강을 이룹니다.',
    industry: '여름에도 바위틈에서 차가운 얼음이 어는 신기한 \'얼음골\'에서 자란 꿀사과가 유명합니다. 아주 작은 물질을 다루는 첨단 기술인 \'나노 산업\'도 키우고 있습니다.',
    culture: '우리나라 대표 민요인 밀양아리랑을 부르고, 임진왜란 때 나라를 구한 사명대사를 기리는 \'밀양아리랑대축제\'가 매년 5월에 열립니다.',
  },
  geoje: {
    nature: '우리나라에서 제주도 다음으로 두 번째로 큰 섬이며, 몽돌(동글동글한 돌)이 깔린 해수욕장과 바다 위 바위 절벽인 해금강이 아름답습니다.',
    industry: '세계에서 가장 크고 튼튼한 배들을 만드는 거대한 \'조선소(배 만드는 공장)\'들이 있습니다. 바닷바람을 맞고 자란 향긋한 유자와 알로에가 특산물입니다.',
    culture: '가을인 10월에서 11월 사이, 농업개발원에서 직접 키운 수백만 송이의 가을꽃과 식물을 구경할 수 있는 \'거제섬꽃축제\'가 열립니다.',
  },
  yangsan: {
    nature: '천성산, 영축산 등 경치가 아름답고 험한 높은 산들이 도시를 감싸고 있고, 옆으로는 큰 낙동강이 유유히 흐릅니다.',
    industry: '낙동강 옆 원동 지역에서 봄을 가장 먼저 알리며 피어나는 매실과 튼튼한 돼지고기가 유명합니다. 부산과 가까워 생활용품을 만드는 공장도 많습니다.',
    culture: '매년 3월에는 매화꽃을 보는 \'원동매화축제\'가 열리고, 10월에는 신라 시대의 오래된 역사와 전통을 자랑하는 \'양산삽량문화축전\'이 크게 열립니다.',
  },
  uiryeong: {
    nature: '자굴산이라는 웅장한 산이 중심에 있고, 맑은 남강과 큰 낙동강이 서로 만나는 곳이라 땅이 비옥하고 물이 풍부합니다.',
    industry: '쫄깃한 떡을 향긋한 망개나무 잎으로 감싸서 만든 \'망개떡\'과, 껍질이 얇고 달콤한 수박, 옥수수가 아주 유명합니다.',
    culture: '임진왜란 때 붉은 옷을 입고 나라를 지킨 곽재우 장군과 의병들의 용기를 기억하기 위해, 매년 4월 \'의령 홍의장군축제\'가 열립니다.',
  },
  haman: {
    nature: '남강과 낙동강 주변으로 물이 넘치면서 만들어진 넓고 평평한 땅이 많아, 비닐하우스를 짓고 농사하기에 아주 좋은 조건입니다.',
    industry: '추운 겨울에도 따뜻한 비닐하우스에서 달고 맛있게 자라는 \'함안 겨울 수박\'이 전국에서 제일 유명합니다. 달콤한 파수 곶감도 많이 납니다.',
    culture: '매년 5월 부처님 오신 날 즈음, 무진정이라는 연못 위로 참나무 숯가루가 불꽃처럼 아름답게 떨어지는 \'함안 낙화놀이\'가 열립니다. 4월에는 옛 아라가야 문화를 기리는 \'아라문화제\'도 열립니다.',
  },
  changnyeong: {
    nature: '우리나라에서 가장 크고 오래된 자연 늪(생물들이 사는 습지)인 \'우포늪\'이 있어, 희귀한 새와 식물들이 많이 살고 있습니다.',
    industry: '건강에 좋은 양파와 마늘을 아주 많이 기르는 곳으로 유명하며, 매콤하고 아삭한 고추도 많이 재배합니다.',
    culture: '매년 4월, 낙동강 주변 넓은 들판이 노란 유채꽃으로 가득 차는 아름다운 \'창녕 낙동강유채축제\'가 열립니다.',
  },
  gosung: {
    nature: '파도가 잔잔한 호수 같은 바다(당항포)와 맞닿아 있으며, 바닷가 바위 곳곳에 옛날 공룡들이 걸어 다녔던 발자국 화석이 아주 많이 남아 있습니다.',
    industry: '깨끗한 바다에서 기르는 굴과 조개인 가리비가 아주 맛있습니다. 자연을 보호하며 농약을 치지 않고 농사짓는 \'생명환경농업\'을 실천합니다.',
    culture: '3~4년마다 9월에서 10월 사이, 신기한 공룡의 역사에 대해 배우고 재미있게 체험할 수 있는 \'경남고성공룡세계엑스포\'가 아주 크게 열립니다.',
  },
  namhae: {
    nature: '섬 전체가 산과 바다로 이루어져 경치가 매우 아름다우며, 지금은 남해대교 같은 멋진 다리들로 육지와 연결되어 있습니다.',
    industry: '따뜻한 바닷바람을 맞고 튼튼하게 자라 영양분이 가득한 \'남해 마늘\'과 시금치, 그리고 바다에서 잡은 은빛 멸치가 아주 유명합니다.',
    culture: '매년 10월, 옛날 독일로 일하러 갔던 분들이 모여 사는 예쁜 독일 마을에서 소시지와 함께 즐기는 \'남해 독일마을 맥주축제\'가 열립니다.',
  },
  hadong: {
    nature: '우리나라에서 가장 웅장하고 높은 지리산 자락과, 모래가 맑고 깨끗한 섬진강이 서로 만나는 곳이라 자연이 살아 숨 쉽니다.',
    industry: '지리산 비탈밭에서 농약 없이 기르는 \'야생 녹차\'와, 섬진강 맑은 물속에서만 잡히는 작은 조개인 \'재첩\'이 으뜸입니다.',
    culture: '매년 3월 말에서 4월 초, 화개장터 주변 십 리(약 4km) 길에 하얀 벚꽃이 눈처럼 피어나는 \'화개장터 벚꽃축제\'가 열리고, 5월에는 야생차 축제가 열립니다.',
  },
  sancheong: {
    nature: '지리산의 가장 높은 봉우리인 천왕봉이 있으며, 깊은 산골짜기와 맑은 물이 흐르는 래프팅 명소인 경호강이 있습니다.',
    industry: '맑은 공기와 물을 먹고 자라 건강에 아주 좋은 \'한방 약초\'와 쫄깃하고 달콤한 고종시 곶감, 지리산 흑돼지가 아주 유명합니다.',
    culture: '전통 한의학과 건강한 약초에 대해 배우고 동의보감촌을 체험하는 \'산청한방약초축제\'가 매년 9월에서 10월 가을에 열립니다.',
  },
  hamyang: {
    nature: '지리산과 덕유산이라는 두 개의 거대한 산맥 사이에 자리 잡고 있어, 끝없이 이어지는 산봉우리와 맑고 울창한 숲 계곡이 많습니다.',
    industry: '깊은 산속 맑은 기운을 먹고 자라는 귀한 \'산삼\'과, 산속의 큰 일교차 덕분에 아주 아삭하고 단맛이 강한 사과, 달콤한 양파가 유명합니다.',
    culture: '매년 9월, 산삼을 직접 캐보고 건강에 좋은 산삼 요리를 맛보며 자연을 즐기는 \'함양산삼축제\'가 상림공원 주변에서 열립니다.',
  },
  geochang: {
    nature: '높은 산맥들에 둥글게 둘러싸인 분지 지형이며, 여름이면 시원하고 맑은 물이 흐르는 수승대와 같은 훌륭한 계곡들이 아주 많습니다.',
    industry: '낮과 밤의 온도 차이가 아주 커서 과일이 자라기 좋아, 전국에서 손꼽히는 달콤하고 맛있는 \'거창 사과\'와 포도, 딸기를 많이 재배합니다.',
    culture: '매년 7월 말에서 8월 여름, 시원한 계곡물이 흐르는 야외 자연 무대에서 연극을 감상하는 특별한 축제인 \'거창국제연극제\'가 열립니다.',
  },
  hapcheon: {
    nature: '웅장한 바위가 멋진 가야산과 봄이면 꽃으로 덮이는 황매산이 있으며, 커다란 호수인 합천호가 있어 풍경이 아름답습니다.',
    industry: '깨끗한 환경에서 좋은 흙을 먹고 자란 소고기인 \'합천황토한우\'와 튼튼한 돼지고기가 유명하며, 양파 농사도 많이 짓습니다.',
    culture: '매년 4월 말에서 5월 초, 황매산 꼭대기 넓은 평원에 분홍빛 철쭉꽃이 끝없이 피어나는 장관을 볼 수 있는 \'황매산 철쭉제\'가 열립니다.',
  },
};
